...
class PriorityFormView extends TPage
{
    protected $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Prioridade');
        ...
        $this->form->addActionLink(_t('List'), new TAction(array('PriorityDataGridView', 'onReload')), 'fa:table blue');
