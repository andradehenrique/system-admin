...
class TagDataGridView extends TPage
{
    protected $form;
    protected $datagrid;
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_search_Tag');
        ...
        $this->form->addActionLink(_t('New'), new TAction(['TagFormView', 'onClear']), 'fa:plus-circle green');
        $this->form->addActionLink(_t('Clear'), new TAction([$this, 'clear']), 'fa:eraser red');

        // keep the form filled with the search data
        $this->form->setData(TSession::getValue('TagDataGridView_filter_data'));
        ...
        $col_description->setTransformer([$this, 'setTagColor']);
        ...
        $action1 = new TDataGridAction(['TagFormView', 'onEdit'],   ['key' => '{id}']);
    ...
    public function setTagColor($status, $object, $row)
    {
