...
class CategoryDataGridView extends TPage
{
    protected $form;
    protected $datagrid;
    ...
    public function __construct()
    {
        ...
        $this->form->addActionLink(_t('New'), new TAction(['CategoryFormView', 'onClear']), 'fa:plus-circle green');
        $this->form->addActionLink(_t('Clear'), new TAction([$this, 'clear']), 'fa:eraser red');

        // keep the form filled with the search data
        $this->form->setData(TSession::getValue('CategoryDataGridView_filter_data'));
        ...
        $col_description->setTransformer([$this, 'setCategoryColor']);
        ...
        $action1 = new TDataGridAction(['CategoryFormView', 'onEdit'],   ['key' => '{id}']);
    ...
    public function setCategoryColor($status, $object, $row)
    {
